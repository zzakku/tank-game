...
#define lastDraw RLGL.currentBatch->draws[RLGL.currentBatch->drawCounter - 1]
            if (lastDraw.mode == RL_POINTS) lastDraw.vertexAlignment = 4 - (lastDraw.vertexCount%4);
            else if (lastDraw.mode == RL_LINES) lastDraw.vertexAlignment = ((lastDraw.vertexCount < 4)? lastDraw.vertexCount : lastDraw.vertexCount%4);
            else if (lastDraw.mode == RL_TRIANGLES) lastDraw.vertexAlignment = ((lastDraw.vertexCount < 4)? 1 : (4 - (lastDraw.vertexCount%4)));
            else lastDraw.vertexAlignment = 0;
#undef lastDraw
...
void rlVertex3f(float x, float y, float z)
{
    ...
    if (RLGL.State.vertexCounter > (RLGL.currentBatch->vertexBuffer[RLGL.currentBatch->currentBuffer].elementCount*4 - 4))
    {
        ...
        else if (RLGL.currentBatch->draws[RLGL.currentBatch->drawCounter - 1].mode == RL_POINTS)
        {
